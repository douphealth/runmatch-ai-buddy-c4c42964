...
export const shoeDatabase: Shoe[] = [
  ...
  },
  {
    ...
    terrain: ['road'],
    bestDistances: ['5k', '10k', 'half-marathon', 'marathon'],
    bestFor: ['recovery', 'long-run', 'beginner'],
    widthOptions: true,
    priceUSD: 170,
    injuryFriendly: ['plantar-fasciitis', 'knee-pain', 'shin-splints', 'achilles', 'it-band'],
    amazonASIN: 'SEARCH',
    reviewURL: 'https://gearuptofit.com/review/best-running-shoes/',
    imageURL: '/images/shoes/placeholder.jpg',
    highlights: ['Maximum cushion', 'Recovery king', 'Ultra-soft ride'],
  },
  {
    id: 'hoka-rocket-x-2',
    brand: 'Hoka',
